...
**Anna Wallin**,_ Metadata Manager:_ Anna led the cataloging of all objects and ensured that metadata followed Dublin Core, CollectionBuilder, and group-specific standards. She maintained the master metadata spreadsheet and standardized data entry for consistency and accuracy across the collection. Anna performed metadata quality reviews and made final decisions about how each object was described.
